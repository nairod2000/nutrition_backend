...
def getUnits():
    ...
    unitDict = {}
    for unit in units:
        unitDict[str(unit.name).lower()] = unit.abbreviation
    return unitDict
...
def getNutrients():
    ...
    for nutrient in nutrients:
        nutrientDict[str(nutrient.name).lower()] = nutrient.unit
    return nutrientDict
...
def read_items(jsonl_file,batch_size=1000):
    ...
    with open(jsonl_file,'r',encoding='utf-8') as file:
        for food_item in file:
            ...
            if unitAbbreviation not in units.values():
            ...
            for nutrient_name in nutrientsDic.keys():
                ...
                if nutrient_name not in nutrients.keys():
